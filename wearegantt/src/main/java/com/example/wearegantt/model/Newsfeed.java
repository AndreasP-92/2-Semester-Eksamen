...
public class Newsfeed {
    ...
    private int fk_orgName;

    public Newsfeed(int newsfeed_id, String newsfeed_news, String newsfeed_title, String newsfeed_img, String newsfeed_datetime, int fk_orgName){
    ...
    public int getNewsfeed_id() { return newsfeed_id; }

    public void setNewsfeed_id(int newsfeed_id) { this.newsfeed_id = newsfeed_id; }

    public String getNewsfeed_news() { return newsfeed_news; }
    ...
    public String getNewsfeed_img() { return newsfeed_img; }

    public void setNewsfeed_img(String newsfeed_img) { this.newsfeed_img = newsfeed_img; }

    public String getNewsfeed_datetime() { return newsfeed_datetime; }

    public void setNewsfeed_datetime(String newsfeed_datetime) { this.newsfeed_datetime = newsfeed_datetime; }

    public int getFk_orgName() { return fk_orgName; }

    public void setFk_orgName(int fk_orgName) { this.fk_orgName = fk_orgName; }
